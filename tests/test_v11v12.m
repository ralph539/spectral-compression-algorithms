...
tic;
[W11, V11, flag11, q11, qv11] = eigen_2025(imat, n, v, m, eps, maxit, percentage, [], genere);
t11 = toc;

fprintf('Temps power_v11 = %.3e s\n', t11);

fprintf('Qualité des couples propres (par rapport au critère d''arrêt) = [%0.3e , %0.3e]\n', min(qv11), max(qv11));
fprintf('Qualité des valeurs propres (par rapport au spectre de la matrice) = [%0.3e , %0.3e] \n', min(q11), max(q11));

% méthode de calcul
v = 12; % opitimized power method
...
tic;
[W12, V12, flag12, q12, qv12] = eigen_2025(imat, n, v, m, eps, maxit, percentage, [], genere);
t12 = toc;

fprintf('Temps power_v12 = %.3e s\n', t12);
fprintf('Qualité des couples propres (par rapport au critère d''arrêt) = [%0.3e , %0.3e]\n', min(qv12), max(qv12));
fprintf('Qualité des valeurs propres (par rapport au spectre de la matrice) = [%0.3e , %0.3e] \n', min(q12), max(q12));
